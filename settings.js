...
global.owner = process.env.OWNER_NUMBER  || '263778331068' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'youre session id' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "263778331068,94787820101" : process.env.MODERATORS ,    
